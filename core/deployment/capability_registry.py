...
def build_default_release_capability_registry() -> CapabilityRegistry:
    ...
    registry.register(READINESS_CAP_DECISION_CYCLE, [READINESS_SVC_RUNTIME_LOOP, READINESS_SVC_DECISION_COMPILER])
    registry.register(READINESS_CAP_RISK_EVALUATION, [READINESS_SVC_RISK_SERVICE])
    registry.register(READINESS_CAP_LEDGER_PERSISTENCE, [READINESS_SVC_LEDGER_STORE, READINESS_SVC_DECISION_RECORD_WRITER])
    ...
    registry.register(READINESS_CAP_FEEDBACK_LOOP, [READINESS_SVC_FEEDBACK_LOOP, READINESS_SVC_BRAIN_TRACKER])
    registry.register(READINESS_CAP_GOVERNANCE_RULES, [READINESS_SVC_GOVERNANCE_SERVICE, READINESS_SVC_GOVERNANCE_RULE_ENGINE])
