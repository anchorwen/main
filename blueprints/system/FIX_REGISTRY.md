...
| FIX-20260610-007 | 2026-06-10 | execution-guards, brains-services, runtime-live, observability, training | **系统解冻+DataHealth+BTC V2+XAU V1+数据加速**: (Phase 1-3) budget+leaderboard+calibrator. (Phase 4-5) 24源+DingTalk. (MLOps) V1禁用→V2 PIT训练(BTC 54样本 AUC=0.82, XAU 715样本 AUC=0.64). (B) hesitation 0.08→0.05. (C) cold_explore扩展swing 0.01lot. DQAF-20260610-001全量交付. | RC-03, RC-06, RC-10, RC-12 |
