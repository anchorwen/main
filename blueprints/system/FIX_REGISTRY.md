...
|--------|------|--------|---------|------------|
| FIX-20260607-146 | 2026-06-07 | runtime-live, testing | **BLE001 governance Phase 1: `fail_open_guard()` context manager**: New DEGRADE-level wrapper in `fault_handler.py` as drop-in replacement for bare `except Exception: pass`. 5 unit tests added. Phase 2 (governance): replace 26 FAIL_OPEN sites in hot path. Phase 3 (marking): 530 DEGRADE/FIRE_FORGET sites. | RC-07 |
