...
| FIX-20260605-126 | 2026-06-05 | governance, brains-services, deployment-config | **Brain_Rev_M30_V1/V2 archived**: V1 PF=1.65→0.46 after evaluation bug correction (FIX-073 — hardcoded ±1.5 ATR inflated metrics). V2 SL/TP=1.5/2.5 mismatched with m30_reversion strategy SL=2.5/TP=0.7. m30_reversion strategy already disabled (enabled:false). Brain roster: 5 archived total. Swing_LGB_M15/M30 retained as pending retrain on new SL/TP surface. | RC-11 |
