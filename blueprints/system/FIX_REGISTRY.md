...
|--------|------|--------|---------|------------|
| TECH_DEBT-005 | 2026-06-19 | execution-guards | **Strategic: Dynamic tick-based session detection**. CME Globex moving to 24/7 trading will obsolete all static time windows. Replace hardcoded _SESSIONS table with tick_time + market_book depth auto-detection of physical market state (open/rollover/closed). Design post Operation Clean Slate. | RC-12 |
