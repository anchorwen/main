...
| FIX-20260611-005 | 2026-06-11 | runtime, ledger, contracts, observability | **数据可靠性三阶段事件溯源**: Journal Close(Phase 2 PositionClosed adapter), Journal Open(PositionOpened), PnP Ledger per-position结算, Governance追加事件. Strangler Fig #11-13从live_cycle.py提取. Journal去重+SLA监控. | RC-06, RC-12 |
