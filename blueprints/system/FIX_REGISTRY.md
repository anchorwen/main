...
| FIX-20260611-017 | 2026-06-11 | config, ledger, observability, scripts | **数据防线闭合**: statarb exit unbundling (trail 0.3→1.0, hesitation 6→24). Journal intent_id跨ticket去重. DataHealth bootstrap首cycle. Iron Law #10: BLE001 108→105. XAU V10_H1_Directional注册. | RC-06 |
