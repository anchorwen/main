...
| FIX-20260616-005 | 2026-06-17 | infrastructure, observability | **Semantic-Layer Data Integrity Auditor (DQAF-20260616-005)**: 6-dimension institutional audit: (1) journal vs ledger PnL reconciliation, (2) snapshot-journal structural check, (3) active_position state persistence, (4) orphan contamination detection, (5) bridge micro-health P99 latency, (6) tick precision assertion. DingTalk webhook push. Replaces physical-layer audit_data_health.py. | RC-07 |
