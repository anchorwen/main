...
| FIX-20260528-024 | 2026-05-28 | deployment_lifecycle | verify.py `run_pytest()` hangs on 2700+ tests: `capture_output=True` pipe buffer deadlock. Replaced with `tempfile.TemporaryFile`. | RC-06 |
