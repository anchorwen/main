...
| FIX-20260528-013 | 2026-05-28 | contracts-training, deployment-config | barrier_12bar RR symmetry: all 10 training contracts + live.yaml SL/TP 3.0→1.5 (RR=0.50→1.0). At MetaFilter's 55-58% p_win, RR=0.50 mathematically required >66.7% for +EV — structurally unachievable. RR=1.0 needs only >50%, yielding Kelly +0.10~+0.16. Full pipeline rebuild required. | RC-06 |
