...
| FIX-20260610-007 | 2026-06-10 | execution-guards, brains-services, runtime-live, observability | **系统解冻 + DataHealth 基建收尾**: (Phase 1-3) budget跨日重置+leaderboard等权兜底+calibrator持久化. (Phase 4-5) 补齐14个HIGH/MEDIUM检查→24源全覆盖. (Hotfix) tail-read优化 XAU LIGHT 117ms→12ms; FS schemas契约修复; golden_master病理/正常阻塞区分; leaderboard crash修复; journal_vs_pnl_ledger计数修正; DingTalk适配器 send_data_health_alert.py 双品种推送测试通过. DQAF-20260610-001 IC Mandate 全量交付. | RC-03, RC-06, RC-10 |
