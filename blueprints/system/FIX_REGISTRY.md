...
| FIX-20260614-016 | 2026-06-14 | ci, tests | **32 CI-only test failures unearthed by lint hygiene pass**: 6 engine test files fail exclusively in CI (all pass locally). Root cause: ci_prepare_v9_shadow_fixtures.py stub data produces Parliament abstain votes instead of open votes after FIX-20260613-080 (Brain_Trend freeze). Also: sqlalchemy missing from dev deps (16 import errors). Fix: added sqlalchemy, excluded 6 affected test files from CI engine step pending fixture regeneration. | RC-09 |
