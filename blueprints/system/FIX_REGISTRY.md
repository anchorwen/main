...
| FIX-20260528-018 | 2026-05-28 | deployment-config | Online_MLP_V1 path defaults cleanup: `ONLINE_BRAIN_PATH` → `None` in path_defaults.py. Brain retired 2026-05-25 (pnl:critical), config retained for smoke test compatibility. Startup `missing_yaml_entries` warning is cosmetic (auto-discovery handles it). | RC-09, RC-11 |
