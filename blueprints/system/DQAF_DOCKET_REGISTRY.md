...
| DQAF-20260621-034 | 2026-06-21 | Sev 2 | **Trailing SL 48.7%仓位零快照 + 46.3%有快照trail未移动 = STATE_INITIALIZATION_DEADLOCK**: V3 恢复 current_sl=0.0 与 snapshot 守卫 current_sl<=0→SKIP 形成相互死锁, Δ PnL=+282R。FIX-037 三刀: MT5 直读 SL + force_init_snapshot + fallback_unmanaged。 | **APPROVED → HOTFIX DEPLOYED** — IC Mandate 签发, FIX-037 deployed | FIX-20260621-037 |
