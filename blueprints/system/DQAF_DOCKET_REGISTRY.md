...
| DQAF-20260621-034 | 2026-06-21 | Sev 2 | **Trailing SL 48.7%仓位零快照 + 46.3%有快照trail未移动 = STATE_INITIALIZATION_DEADLOCK**: V3 恢复 current_sl=0.0 与 snapshot 守卫 current_sl<=0→SKIP 形成相互死锁, Δ PnL=+282R。FIX-037 三刀: MT5 直读 SL + force_init_snapshot + fallback_unmanaged。FIX-038 追加两刀: V3 strategy 恢复 + entry_price 不可变锁 (实盘审计发现策略空间坍塌+开仓价漂移)。 | **APPROVED → HOTFIX DEPLOYED (FIX-037 + FIX-038)** — IC Addendum 签发 | FIX-20260621-037, FIX-20260621-038 |
