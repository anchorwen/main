...
|-----------|------|---------|---------|--------|----------|
| DQAF-20260621-044 | 2026-06-21 | Sev 2 | BTC ConformalCalibrator p_win 自 2026-06-10T08:37Z 塌缩为精确 0.5 (永久). 根因: commit 0240641f 将 cold_explore 前置到 MetaFilter 之前, _is_cold_explore=True 在 MetaFilter 成功产出真实 p_win (0.06-0.67, pred_history 109条证据) 后未被清除, line 924 无条件覆写为 0.50. XAU swing 策略 6/18 同步沦陷. ReB: COLD_EXPLORE_PREEMPTIVE_OVERRIDE. | **APPROVED → CLOSED** — FIX-20260621-044: MetaFilter 成功产出 p_win 后清除 _is_cold_explore=False (5行修复). 毒流代谢期 ~50 trades. 严禁手动清空 calibrator history. | FIX-20260621-044 |
