...
| FIX-20260610-007 | 2026-06-10 | cursor-agent | — | **Budget解冻+Calibrator持久化+数据加速**: strategy_budget跨日unpause; conformal_calibrator merge persist; reentry_guard hesitation 0.08→0.05; strategy_line cold_explore扩展到swing; MetaFilter train-serve特征空间错位紧急止血(Sev1)+V2 MLOps管线(PIT+标签+字典同构). | RC-03, RC-06, RC-12 |
