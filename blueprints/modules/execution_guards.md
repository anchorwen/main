...
| FIX-20260610-007 | 2026-06-10 | cursor-agent | — | **Budget解冻+Calibrator+数据加速+XAU方向分离**: budget跨日unpause; calibrator merge; hesitation 0.08→0.05; cold_explore扩展swing; MetaFilter V1止血+V2 PIT; XAU方向分离(LONG 381 AUC=0.68, SHORT 334 AUC=0.67)+MetaFilterGate路由; 字典同构启动断言. | RC-03, RC-06, RC-12 |
