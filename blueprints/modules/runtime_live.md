...
| FIX-20260523-008 | 2026-05-24 | cursor-agent | — | Track 3d ConformalCalibrator integration in daily_ops: `_step_online_feedback()` creates ConformalCalibrator, cold-starts from journal, passes to both hooks. Returns conformal_samples, conformal_warm, conformal_threshold, conformal_q10, conformal_clamp_hits diagnostics. | calibrator lifecycle for Track 3d |
