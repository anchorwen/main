...
| FIX-20260530-066 | 2026-05-30 | cursor-agent | — | Phase 2 position_snapshots.jsonl: per-cycle management phase state recording (ticket, bars_held, unrealized_pnl_r, current_volatility, trailing_sl_distance). log_and_continue() wrapper. Enables meta-classifier training. | RC-06 |
