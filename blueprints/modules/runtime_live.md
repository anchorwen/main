...
| FIX-20260529-050 | 2026-05-29 | cursor-agent | — | Last Mile Protocol — FTC paradigm unification: (1) live_cycle.py MT5 IPC sites (positions_get, account_info, copy_rates_from_pos, history_deals_get) converted from silent pass to FTC(CRASH) with variable pre-initialization (variable scope leakage guard). (2) fault_handler.py docstring: variable scope warning added. (3) live_intent_loop.py MT5 IPC recovery/reconstruction/audit sites → FTC(CRASH) with pre-init. (4) "Crask-loop" typo fixed. | RC-07 |
