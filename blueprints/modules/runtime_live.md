...
| FIX-20260608-001 | 2026-06-08 | cursor-agent | — | **DingTalk alert pipeline P0 repair**: live_intent_loop.py now passes symbol=args.symbol to LiveAlertHub. Replaced 1 BLE001 site (AlertConfigLoader YAML read) with fail_open_guard() per Iron Law #10. | RC-06 |
