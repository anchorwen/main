...
| FIX-20260528-015 | 2026-05-28 | cursor-agent | — | live pipeline startup fixes: live_cycle.py add `import numpy as np` at function top (conditional imports at L4506/L6503 caused UnboundLocalError in no-mt5 path). live_intent_loop.py initialize daily_feature_provider before no-mt5 guard block (was UnboundLocalError). | RC-06 |
