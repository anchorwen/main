...
| File | Role | Status |
|------|------|--------|
| `core/contracts/cap_result.py` | CapResult[T] + _SuccessProof (scope-gated proof token) | PLANNED |
| `core/contracts/phantom_contract.py` | Phantom Contracts decorator + PhantomStub | PLANNED |
| `core/runtime/typed_clock.py` | MonotonicInstant, WallInstant, Duration — three incompatible time types | PLANNED |
...
| `scripts/verify_phantom_contracts.py` | Phantom offline verifier (WAL state reconstruction + replay) | PLANNED |
...
| — | — | — | — | Module initial registration (UGR-P01). No fixes yet. | — |
