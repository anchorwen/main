...
| FIX-20260628-060 | 2026-06-28 | cursor-agent | — | DQAF-060 L3: Event Sourcing semantic conflation — BrainRanking.to_dict() inf-safe (math.isfinite guard), dynamic_brain_weighter.py inf-awareness comments | L3-architecture |
