...
|--------|------|--------|--------|---------|------------|
| FIX-20260528-013 | 2026-05-28 | cursor-agent | — | barrier_12bar RR symmetry fix: all 10 training contracts + live.yaml SL/TP changed from 3.0/1.5 (RR=0.50, requires p_win>66.7%) to 1.5/1.5 (RR=1.0, requires p_win>50%). Meta contract SL 4.0→1.5. At MetaFilter's honest 55-58% win rate, RR=0.50 was structurally negative Kelly (-0.26). RR=1.0 yields Kelly +0.10~+0.16. Pipeline retraining required to rebuild labels + brains with new parameters. | RC-06 |
