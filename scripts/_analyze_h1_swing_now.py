#!/usr/bin/env python3
"""
H1 Swing XAU 实盘表现审计 — Iron Law #11 合规
...
用法: python scripts/_analyze_h1_swing_now.py
"""
...
def main():
    ...
    n_total = len(settled)
    print("=== H1 Swing XAU 实盘审计 ===")
    print(
        f"Journal H1 entries: open={len(opens)}, close={len(closes)}, modify_sltp={len(modifies)}"
    )
...
""")
    ...
    print(f"\n[analysis complete — {n_total} settled H1 trades]")
