...
- `bootstrap_v9.py` → `core.brains.services.brain_registry_loader`, `core.contracts.exceptions`, `core.deployment.environment_config`, `core.deployment.service_container`, `core.execution.meta_signal_filter`, `core.features.adapters.microstructure_feature_adapter`
...
- `governance_evaluator.py` → `core.brains.services.brain_promotion`, `core.deployment.brain_alert`, `core.governance.governance_rule_engine`
...
- `live_order_sender.py` → `core.contracts.domain.communication_envelope`, `core.contracts.enums`, `core.contracts.strategy_magic`, `core.deployment.environment_config`, `core.deployment.service_container`, `core.execution.broker_adapter`, `core.execution.mt5_broker_adapter`, `core.execution.mt5_worker`, `core.protocol.live_execution_contract`, `core.protocol.schema_versions`, `core.protocol.services.zmq_receipt_listener`, `core.runtime.shadow_ops.dispatch_filter`
...
- `feature_service.py` → `apps.engine.runtime_loop`, `core.contracts.ids`, `core.deployment.brain_alert`, `core.execution.pre_trade_guards`, `core.features.schemas.registry`, `core.features.stale_feature_guard`, `core.features.store_contracts`
...
- `live_daily_provider.py` → `core.contracts.exceptions`, `core.execution.mt5_worker`, `core.features.computers.daily_computer`
...
- `execution_state.py` → `core.runtime.settlement_queue`, `core.runtime.time_utils`, `core.state.catalog`, `core.state.writer`
...
- `dispatch_filter.py` → (无内部依赖)
- `live_fire_breaker.py` → (无内部依赖)
- `micro_scaler_scorer.py` → `core.contracts.exceptions`, `core.features.schemas.v9_institutional_schema`, `core.runtime.shadow_ops.trigger_contract`
- `runtime.py` → `core.contracts.exceptions`, `core.runtime.shadow_ops.micro_scaler_scorer`, `core.runtime.shadow_ops.telemetry`, `core.runtime.shadow_ops.trigger_contract`
- `telemetry.py` → (无内部依赖)
- `trigger_contract.py` → `core.contracts.exceptions`
...
- `_audit_storm_forensics_20260819.py` → (无内部依赖)
...
- `_audit_xau_votes_today.py` → (无内部依赖)
...
- `reconcile_store_schemas.py` → `core.features.local_feature_store`, `core.features.schemas.registry`, `core.features.store_contracts`
...
- `governance_scheduler.py` → `core.brains.brain_registry`, `core.brains.services.brain_promotion`, `core.deployment.governance_evaluator`, `core.feedback.brain_performance_tracker`, `core.feedback.brain_pnl_ledger`, `core.feedback.live_journal_metrics`, `core.governance.governance_rule_engine`, `core.governance.governance_service`, `core.governance.shadow_tracker`, `core.training.utils`
